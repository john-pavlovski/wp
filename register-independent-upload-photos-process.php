...
if (!empty($_FILES)) {
	...
	if($image_mime_type[0] < "400" || $image_mime_type[1] < "600") {
		//part of the code is from: http://www.geekality.net/2011/05/01/php-how-to-proportionally-resize-an-uploaded-image/?PHPSESSID=2dfwxu1mrzo20tccn9e491a842tpws07o51442cn
